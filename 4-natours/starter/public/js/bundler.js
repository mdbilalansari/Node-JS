...
var dispalyMap = exports.dispalyMap = function dispalyMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWRiaWxhbGFuc2FyaTEyMzQiLCJhIjoiY2xyZHlkbTJjMTV6cTJqbGRybmcwMXp0ZSJ9.sUmO_J6NQ0t0bEimHjv_QQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/mdbilalansari1234/clre1cy9j00c601pig9oc3g28',
    // style URL
    scrollZoom: false
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          (0, _alerts.showAlert)('success', 'Booking is successful');
          _context.next = 13;
          break;
        case 9:
          _context.prev = 9;
